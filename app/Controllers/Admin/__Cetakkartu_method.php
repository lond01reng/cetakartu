...
class Cetakkartu extends BaseController
{
    ...
    public function tunggalPdf($nota = null, $jurs=null)
    {
        ...
        foreach($data as $key=>$dt){
            ...
            $this->ktp_id($ml,$row,$boxh,$boxw,$bgh,$xdt1,$ytext,$nisn,$nama, $nis,$prodi,$lahir,$ortu,$alamat1,$alamat2, $sekolah, $ks,$nip,$foto,$ttd,$tgl,$nick,$style,$bg2);
            ...
            // $pdf->write2DBarcode($nisn, 'QRCODE,H', $boxw-20, $row*$boxh+38.5, 15, 15, $style, 'N');
    ...
    private function ktp_id($ml,$row,$boxh,$boxw,$bgh,$xdt1,$ytext,$nisn,$nama,$nis,$prodi,$lahir,$ortu,$alamat1,$alamat2,$sekolah,$ks,$nip,$foto,$ttd,$tgl,$nick,$style,$bg2){
        $pdf=$this->pdf;
        //cardL
        $pdf->SetFont('Ubuntu', 'B', 14);
        $pdf->SetTextColor(29,32,136);
