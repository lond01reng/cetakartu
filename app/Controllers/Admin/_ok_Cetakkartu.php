...
class Cetakkartu extends BaseController
{
    ...
    public function generatePdf($nota = null, $jurs=null)
    {
        ...
        $pdf->Output('CetaKartu_'.$nota.'_'.$sekolah.'_'.$jurs.'.pdf', 'I');
    }

    public function pribadiPdf($nota = null, $nisn=null)
    {
        // $pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, array(200,300));
        $pdf=$this->pdf;
        $pdf->SetCreator(PDF_CREATOR);
        ...
        $row=0;
            ...
            // $this->$tmpl($ml,$row,$boxh,$boxw,$bgh,$nisn,$nama, $nis,$prodi,$lahir,$ortu,$alamat1,$alamat2, $sekolah, $ks,$nip,$foto,$ttd,$tgl,$nick,$qrsty,$bg2,$plong);
            $this->ktp_id($ml,$row,$boxh,$boxw,$bgh,$nisn,$nama,$nis,$prodi,$lahir,$ortu,$alamat1,$alamat2,$sekolah,$ks,$nip,$foto,$ttd,$tgl,$nick,$qrsty,$bg2, $plong);
            ...
            // endR
        $this->response->setContentType('application/pdf');
        $pdf->Output('CetaKartu_'.$nama.'_'.$sekolah.'.pdf', 'I');
    }
